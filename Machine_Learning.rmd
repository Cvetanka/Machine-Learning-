...
The initial idea behind employing three different ML approaches was to build a model based on combined predictors. However it turned out that the methods are not compatible to be combined (the algorithm does not converge), but as stand alone they are very accurate and provide excellent results.   
...
Model1: Training set: no one misclassified case. Testing set: 49 out of 4904 or 1%

Model 2:Training set: 857 out of 14718 or 5.8%. Testing set: 369 out of 4904 or 7.5%

Model 3: Training set: 597 out of 14718 or 4%. Testing set: 423 out of 4904 or 8.6%
