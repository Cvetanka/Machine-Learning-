...
Out of sample error without preprocessing: Random_Forest  (0.016) SVM (0.088) KNN (0.127)  
Out of sample error with preprocessing: Random_Forest (0.016) SVM (0.028) KNN (0.053)
...
The error rate of combined model is 1%, what is not better than the error rate of Random Forest alone (0.98%)
```{r}
